...
The steps were:
1. Load the dataset
Loaded all three sheets (“Primary”, “Lower secondary”, “Upper secondary”).

2. Remove unnecessary columns
Dropped fields such as:
• Data source
• Population data
...
• Stopped after “Zimbabwe” to remove irrelevant entries
...
• Some countries have strong female dominance in completion rate, while others show strong male advantage.
